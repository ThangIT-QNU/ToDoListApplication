...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.status.setText(task.isComplete() ? "HOÀN THÀNH" : "ĐANG THỰC HIỆN");
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                case R.id.menuDelete:
                    ...
                    alertDialogBuilder.setTitle("Xác nhận").setMessage("Bạn có chắc chắn muốn xóa nhiệm vụ không").
                ...
                case R.id.menuComplete:
                    ...
                    completeAlertDialog.setTitle("Đã hoàn thành nhiệm vụ!").setMessage("Bạn có chắc chắn muốn đánh dấu nhiệm vụ này là đã hoàn thành.").
